...
Написать программу суммирующую элементы двумерного массива (матрицы) целых чисел, измерить время работы при суммировании как по столбцам, так и по строкам. Сравнить результаты. Для замеров можно использовать класс Timer. В репозитории в директории homework создать директорию со своей фамилией, внутри этой директории создать директорию 01, файл с решением положить внутрь.

...
Во второй версии добавлено:

1) Использование констант с помощью класс unordered map<>
2) Использование скобок в арифметическом выражении
3) Переработка структуры программы. Создан класс Calculator, методы которого осуществляют вычисления, получение токенов и проверку токенов на валидность.

...
public:
    ...
    {   
        ...
        else throw std::logic_error("Wrong int");
    }
    /**
...
public:
    ...
    {   
        ...
        else throw std::logic_error("Wrong long");
    }
    /**
     Получить следующий токен. Не менять text.
     */
...
public:
    ...
    {   
        ...
        {   
            throw std::logic_error("Wrong double");
        }
    }
    /**
     Получить следующий токен. Не менять text.
...
public:
    ...
    {   
        try
        {
            text = expression;
            result = expr();
            if (Tokenizer<T>::nextToken(text) != Token::End)
            {
        ...
        {
            std::cerr << "Something get wrong" << std::endl;
            throw;
        }
    }
    ...
    T expr()
    {
        ...
        for(;;)
        {
            switch (Tokenizer<T>::nextToken(text))
            {
                ...
                default:
                {
                    throw std::logic_error("invalid operation in expr");
                }
            }
        }
    }
    ...
    {   
        ...
        for(;;)
        {
            switch (Tokenizer<T>::nextToken(text))
            {
                ...
                default:
                {
                    throw std::logic_error("invalid operation in term");
                }
            }
        }
    }

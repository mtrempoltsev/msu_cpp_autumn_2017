...
private:
    ...
    string text; //Поле, в котором хранится выражение
...
void check() {
    ...
    check<int, int>("-1 * 3 + 5 - -1", 3, true);
    check<int, int>("Pi+e", 5, true);
    check<int, int>("8.1 - 6 * 2 / 2", 2, true);
    check<int, int>("2.12344 + 3 * 4 - -2.444", 16, true);
    ...
    check<long, long>("-1 * 3 + 5 - -1", 3, true);
    check<long, long>("Pi+e", 5, true);
    check<long, long>("8.1 - 6 * 2 / 2", 2, true);
    check<long, long>("2.12344 + 3 * 4 - -2.444", 16, true);

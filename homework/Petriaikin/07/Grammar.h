...
class GrammarElement
{
	protected:
		...
		std::vector<std::unique_ptr<GrammarElement>> subelements_; //ѕодчиненные элементы
...
template<typename T>
using AtomicExpressionSpecified = AtomicExpression<T, Calculator<T>>; //Ќужно, чтобы в define не было лишней зап€той

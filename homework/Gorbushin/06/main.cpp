...
// First - was error or not, second - result
template<class T>
std::pair<bool, T> get_answer(string &&s) {
    T res;
    bool error = false;
    try {
        Expression<T> expr(s);
...
void test(string &&s, T true_answer, bool want_error = false) {
    ...
    T res;
    bool was_error;
    tie(was_error, res) = get_answer<T>(string(s));
...
int main(void) {
    ...
    test<double>(string(""), 0, true);
